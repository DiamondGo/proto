...
def add_ChattingServicer_to_server(servicer, server):
    ...
    generic_handler = grpc.method_handlers_generic_handler(
            'service.Chatting', rpc_method_handlers)
...
class Chatting(object):
    ...
    def ChatStream(request_iterator,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.stream_stream(request_iterator, target, '/service.Chatting/ChatStream',
